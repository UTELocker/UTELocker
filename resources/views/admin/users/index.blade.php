        ...
        function deleteTokenRes(id) {
            $.easyAjax({
                ...
                success: function(response) {
                    $('#list-token li[data-id="' + id + '"]').remove();
                }
            })
        }
                            ...
                            <div class="col-12">
                                ...
                                ">
                                    ...
                                    <div style="display: flex">
                                        <button class="mr-2 delete-token" style="cursor: pointer" onclick="deleteTokenRes('${item.id}')">
                                        ...
                                        <div class="mr-2" style="cursor: pointer" onclick="copyTokenRes('${item.id}')">
                                        ...
                                        <div style="cursor: pointer" onclick="openNewTabQr('${item.id}')">
